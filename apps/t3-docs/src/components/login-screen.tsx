    ...
    <div className="h-screen lg:grid lg:grid-cols-2">
      ...
      <div className="text-muted-foreground flex flex-col items-center justify-center gap-8 p-4">
        ...
        <p className="mx-auto text-center lg:w-2/4">
          ...
          our <strong className="text-black">{Type.COOKBOOK}</strong>, get a
          head start with our <strong className="text-black">templates</strong>,
          and build your own projects with our{" "}
          <strong className="text-black">{Type.EXAMPLES}</strong>.
          <br />
          <br />
