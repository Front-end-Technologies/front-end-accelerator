...
export async function POST(req: Request) {
  try {
    ...
    const result = streamText({
      ...
      system: `You are a helpful expert in front-end development with deep knowledge of ${framework.input} and ${framework.output}. You explain like a ${role} with a ${slang} slang. Your output should be 2 codeblocks emphasizing the differences and similarities between the two languages.`,
    });
